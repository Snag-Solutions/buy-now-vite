  ...
  >
    ...
    <div class="font-custom text-base" slot="body">
      {#if chainId !== ChainIdByNetwork[networkId]}<span
          ...
          {#if tokenListing}
            {#if tokenListing?.reservoirListing}
              <div class="box-border border-0 border-solid border-separator">
                ...
                <div
                  class="mt-6 border-0 border-t-[1px] border-separator border-solid pt-6"
                >
            ...
            {:else}
              <div
                class="flex flex-col gap-6 box-border border-0 border-solid border-separator"
              >
                <div class="flex gap-6">
                  <img
                    class="h-24 w-24 rounded"
        ...
        {#if buyListingState && buyListingState !== BuyListingState.Success}
          <div
            class="flex flex-col gap-8 box-border border-0 border-solid border-separator"
          >
        ...
        {#if buyListingState === BuyListingState.Success}
          <div
            class="flex-grow overflow-y-auto text-primary-text box-border border-0 border-solid border-separator"
          >
    ...
    <svelte:fragment slot="footer">
      {#if !buyListingState && chainId === ChainIdByNetwork[networkId]}
        {#if connectedAccount}
          <div
            class="flex flex-row items-center gap-2 mr-auto text-base font-custom"
          >
